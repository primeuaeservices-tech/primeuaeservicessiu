...
export default async function Footer() {
  ...
  const telLink = settings.phone.replace(/\s/g, '');
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="mt-6 flex space-x-4">
              <a href="#" className="text-gray-300 transition-colors hover:text-brand-gold" aria-label="Facebook">
                <Facebook className="h-5 w-5" />
              </a>
              <a href="#" className="text-gray-300 transition-colors hover:text-brand-gold" aria-label="Instagram">
                <Instagram className="h-5 w-5" />
              </a>
              <a href="#" className="text-gray-300 transition-colors hover:text-brand-gold" aria-label="LinkedIn">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              {services.map((service) => (
                <li key={service.name}>
                  <Link href={service.href} className="text-sm text-gray-300 transition-colors hover:text-white">
                    {service.name}
                  </Link>
                </li>
              ))}
